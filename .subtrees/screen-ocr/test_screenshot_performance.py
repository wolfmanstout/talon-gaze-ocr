...
if __name__ == "__main__":
    ...
    if mss_avg is not None:
        ...
        improvement = pil_avg - mss_avg
        improvement_percent = (improvement / pil_avg) * 100

        if improvement > 0:
            print(
                f"MSS is {improvement:.2f}ms faster ({improvement_percent:.1f}% improvement)"
            )
        else:
            print(
                f"PIL ImageGrab is {-improvement:.2f}ms faster ({-improvement_percent:.1f}% improvement)"
            )
